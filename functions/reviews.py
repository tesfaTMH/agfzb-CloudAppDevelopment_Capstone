...
cloudant_username = "ec3e2e91-54d3-406b-ab15-e50870cf018d-bluemix"
cloudant_api_key = "iFgfv2lowNyiyldyhoBFFqiPblA6W_P7K8BsqCRPQdrd"
cloudant_url = "https://ec3e2e91-54d3-406b-ab15-e50870cf018d-bluemix.cloudantnosqldb.appdomain.cloud"
...
def post_review():
    ...
    for field in required_fields:
        if field not in review_data:
            ...
            jsonify({"error": "Missing required field: {}".format(field)})
